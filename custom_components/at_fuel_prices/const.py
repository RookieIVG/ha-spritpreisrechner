...
# Location source: a fixed point on the map, or follow a person/device_tracker.
LOCATION_MODE_FIXED: Final = "fixed"
LOCATION_MODE_ENTITY: Final = "entity"
DEFAULT_LOCATION_MODE: Final = LOCATION_MODE_FIXED
